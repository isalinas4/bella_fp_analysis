...
for d in dates:
    ...
    BLOCKPATH = os.path.join('C:\\Users\\isabe\\Dropbox (University of Oregon)\\UO-Sylwestrak Lab\TDT\Tanks', expt + '-' + d , mice)
    ...
    plt.title( mice + ' ' +  d + ' Nlx/Sal Response')
    plt.legend( )
plt.show()



# THIS WORKS BUT I WILL INCORPARATE IT LATER! 
    ...
    # ax3.set_ylabel('AUC')
    # ax3.set_title(d + ' baseline vs after IP')
    # ax3.set_xticks(np.arange(-1, len(AUC)+1))
    # ax3.set_xticklabels(['','base','after IP',''])
